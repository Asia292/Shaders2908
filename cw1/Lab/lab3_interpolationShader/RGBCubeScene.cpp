...
void RGBCubeScene::initScene()
{
	...
	float positionData[] = 
	{
		...
		-0.2f, 0.4f, 0.0f,		// Middle right 2
		-0.2f, 0.8f, 0.0f,		// Middle right 1
		 0.2f, 0.4f, 0.0f,		// Middle left 2
		 0.2f, 0.8f, 0.0f,		// Middle left 1
		 0.2f, 0.0f, 0.0f,		// Middle left 3
		-0.2f, 0.0f, 0.0f,		// Middle right 3
		 0.2f,-0.4f, 0.0f,		// Middle left 4
		-0.2f,-0.4f, 0.0f,		// Middle right 4
		 0.2f,-0.8f, 0.0f,		// Middle left 5
		-0.2, -0.8f, 0.0f,		// Middle right 5
		-0.6, -0.4f, 0.0f,		// Right 1
		-0.6, -0.8f, 0.0f,		// Right 2
		 0.6f,-0.4f, 0.0f,		// Left 1
		 0.6f,-0.8f, 0.0f,		// Left 2
	};
	...
	float colourData[] = 
	{
		...
		0.0f, 0.0f, 1.0f,	//Blue		0
		0.0f, 0.0f, 0.0f,	//Black		1
		1.0f, 0.0f, 1.0f,	//Magenta	2
		1.0f, 0.0f, 0.0f,	//Red		3
		1.0f, 1.0f, 1.0f,	//White		4
		0.0f, 1.0f, 1.0f,	//Cyan		5
		1.0f, 1.0f, 0.0f,	//Yellow	6
		0.0f, 1.0f, 0.0f,	//Green		7
		1.0f, 0.0f, 0.0f,	//Red		8
		0.0f, 0.0f, 0.0f,	//Black		9
		0.0f, 1.0f, 1.0f,	//Cyan		10
		0.0f, 0.0f, 1.0f,	//Blue		11
		1.0f, 1.0f, 1.0f,	//White		12
		1.0f, 0.0f, 1.0f,	//Magenta	13
