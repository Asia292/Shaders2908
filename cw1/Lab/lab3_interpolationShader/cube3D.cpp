...
void cube3D::initScene()
{
	...
	float positionData[] =
	{
		...
		0.0f, 0.0f, 1.0f,	//top front corner
		0.0f, 0.8f, 0.0f,	//top back corner
		0.8f, 0.4f, 0.5f,	//top right corner
		0.8f, -0.4f, 0.5f,	//bottom right corner
		0.0f, -0.8f, 1.0f,	//bottom front corner
		-0.8f, -0.4f, 0.5f,	//bottom left corner
		-0.8f, 0.4f, 0.5f	//top right corner
	};
	...
	float colourData[] =
	{
		...
		0.0f, 1.0f, 1.0f,	//Cyan		0
		0.0f, 0.0f, 0.0f,	//White		1
		0.0f, 0.0f, 1.0f,	//Blue		2
		0.0f, 0.0f, 1.0f,	//Blue		3
		0.0f, 1.0f, 1.0f,	//Cyan		4
		0.0f, 0.0f, 1.0f,	//Blue		5
		0.0f, 0.0f, 1.0f,	//Blue		6
	};
...
void cube3D::linkMe(GLint vertShader, GLint fragShader)
{
...
void cube3D::resize(int w, int h)
{
	gl::Viewport(0, 0, w, h);
}